...
```html
<script src="https://cdn.hooli.games/sdk/1.0.3/hooligapps.js"></script>
```
...
Event listeners: `init`, `connect`, `ready`, `profile`, `auth_complete`, `user_changed`, `payment`, `payment_complete`, `popup_auth_result`, and `error`.
...
- `open_age_verification` with `{ "adultMode": true }`
